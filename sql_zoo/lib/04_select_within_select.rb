...
def sparse_continents
  ...
  #if any country has greater pop 25mil
  #don't include continent // excludes continent

  #in subq to include continents (an exclusive criteria)
  #list of w pop > 25mill
  #compare those to exclude / include others
